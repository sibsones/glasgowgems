...
def populate():
	...
	cats = {"Bridges": {"description": "Any bridges."},
			...
			"Education related": {"gems": education_related_gems, "description": "Any education related architecture."},
			...
			"Open spaces": {"gems": open_spaces_gems, "description": "Any open space 'architecture'."},
			"Other": {"description": "Any other architecture."},
			"Religion related": {"gems": religion_related_gems, "description": "Any religion related architecture."},
			"Sculptures": {"description": "Any sculptures."},
			"Sports related": {"gems": sports_related_gems, "description": "Any sports related architecture."},
	...
	for cat, cat_data in cats.items():
		...
		for g in cat_data.get("gems", []):
			added_g = add_gem(c, g["name"], g["address"], g["description"] + g["name"], g["image"], g["image_source"], g["likes"], g["reported"])
...
def add_gem(cat, name, address, description, image, image_source, likes, reported):
